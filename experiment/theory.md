...
### <span style="font-family: 'Times New Roman'; font-size: 22px;">1. Linear combination:</span>
...
<span style="font-family: 'Times New Roman'; font-size: 22px;">Then <i>x</i><sup>2</sup>+3<i>x</i>+3 &isin;<i>P</i><sub>2</sub>(<i>x</i>) is a linear combination of <i>p</i><sub>1</sub>(x)=<i>x</i>+1, <i>p</i><sub>2</sub>(x)=<i>x</i><sup>2</sup>+<i>x</i>+1, for <i>α</i><sub>1</sub>=2&isin;<i>R</i>, <i>α</i><sub>2</sub>=1&isin;<i>R</i>, s.t. 
<i>α</i><sub>1</sub><i>p</i><sub>1</sub>(x)+<i>α</i><sub>2</sub><i>p</i><sub>2</sub>(x)=2(<i>x</i>+1)+1(<i>x</i><sup>2</sup>+<i>x</i>+1)=(2<i>x</i>+2)+ (<i>x</i><sup>2</sup>+<i>x</i>+1)=<i>x</i><sup>2</sup>+3<i>x</i>+3</span>
### <span style="font-family: 'Times New Roman'; font-size: 22px;">4. Linear span:</span>
...
### <span style="font-family: 'Times New Roman'; font-size: 22px;">5. Spanning set:</span>
...
### <span style="font-family: 'Times New Roman'; font-size: 22px;">6. Example-I:</span>
...
### <span style="font-family: 'Times New Roman'; font-size: 22px;">7. Example-II: </span>
...
### <span style="font-family: 'Times New Roman'; font-size: 22px;">8. Properties:</span>
...
### <span style="font-family: 'Times New Roman'; font-size: 22px;">9. Summary:</span>
