...
### <span style="font-family: 'Times New Roman'; font-size: 24px;">1. Linear combination:
...
### <span style="font-family: 'Times New Roman'; font-size: 24px;">2. Example:
Consider the vector spaces <i>R</i><sup>2</sup> over <i>R</i></span>
...
### <span style="font-family: 'Times New Roman'; font-size: 24px;">3. Example:
...
### <span style="font-family: 'Times New Roman'; font-size: 24px;">4. Linear span:
...
### <span style="font-family: 'Times New Roman'; font-size: 24px;">5. Spanning set:
If <i>L</i>(<i>S</i>)=<i>V</i>, that is if <i>V</i> is the linear span of <i>S</i> then, <i>S</i> is called a spanning set of <i>V</i> and it is said that <i>S</i> spans <i>V</i>.</span>
![Linear span](images/exp3newimage2.PNG "Linear span")<br>
### <span style="font-family: 'Times New Roman'; font-size: 24px;">6. Example-I:
Let <i>R</i><sup>2</sup> be the vector space over <i>R</i> where <i>S</i> &sube; <i>R</i><sup>2</sup>. Then<br>
...
### <span style="font-family: 'Times New Roman'; font-size: 24px;">7. Example-II: 
i. Consider the vector space <i>P</i><sub>2</sub><i>x</i>  over <i>R</i> and let <i>S</i>={1, <i>x</i>+1, <i>x</i><sup>2</sup>+<i>x</i>+1} &sube; <i>P</i><sub>2</sub><i>x</i> . Then <i>S</i> spans <i>P</i><sub>2</sub><i>x</i> , i.e. <i>L</i>(<i>S</i>)=<i>P</i><sub>2</sub><i>x</i> .</span>
...
### <span style="font-family: 'Times New Roman'; font-size: 24px;">8. Properties:
(i) <i>S</i> is a subset of <i>L</i>(<i>S</i>).</span>
...
### <span style="font-family: 'Times New Roman'; font-size: 24px;">9. Summary:
