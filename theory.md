...
Justification: By definition, <i>L</i>(<i>S</i>)={<i>α</i>.1+<i>β</i>(<i>x</i>+1)+<i>γ</i>(<i>x</i><sup>2</sup>+<i>x</i>+1): <i>α, β, γ</i> &isin;<i>R</i>}. Clearly <i>L</i>(<i>S</i>)  &sube;  <i>P</i><sub>2</sub><i>x</i> . To prove that <i>P</i><sub>2</sub><i>x</i> &sube; <i>L</i>(<i>S</i>). Let <i>a</i><sub>2</sub><i>x</i><sup>2</sup>+<i>a</i><sub>1</sub><i>x</i><sup>1</sup>+<i>a</i><sub>0</sub>  &isin; <i>P</i><sub>2</sub><i>x</i> , where <i>a</i><sub>0</sub>, <i>a</i><sub>1</sub>, <i>a</i><sub>2</sub> &isin; <i>R</i>. Then <i>a</i><sub>2</sub><i>x</i><sup>2</sup>+<i>a</i><sub>1</sub><i>x</i><sup>1</sup>+<i>a</i><sub>0</sub>=<i>α</i>.1+<i>β</i>(<i>x</i>+1)+<i>γ</i>(<i>x</i><sup>2</sup>+<i>x</i>+1) for some <i>α</i>, <i>β</i>, <i>γ</i>  &isin; <i>R</i>. Therefore <i>α</i>=<i>a</i><sub>0</sub>-<i>a</i><sub>1</sub>, <i>β</i>=<i>a</i><sub>1</sub>-<i>a</i><sub>2</sub> and <i>γ</i>=<i>a</i><sub>2</sub>.
Clearly, <i>α</i>.1+<i>β</i>(<i>x</i>+1)+<i>γ</i>(<i>x</i><sup>2</sup>+<i>x</i>+1)=<i>a</i><sub>2</sub><i>x</i><sup>2</sup>+<i>a</i><sub>1</sub><i>x</i><sup>1</sup>+<i>a</i><sub>0</sub>. Thus <i>a</i><sub>2</sub><i>x</i><sup>2</sup>+<i>a</i><sub>1</sub><i>x</i><sup>1</sup>+<i>a</i><sub>0</sub> &isin; <i>L</i>(<i>S</i>), so that <i>P</i><sub>2</sub><i>x</i>  &sube; <i>L</i>(<i>S</i>). Hence <i>L</i>(<i>S</i>)= <i>P</i><sub>2</sub><i>x</i> .
